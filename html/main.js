...
(function(exports) {
  ...
  var getValFromMatrix = function (matrix) {
      return function (rowIndex) {
          return function (colIndex) {
              var rowData = Data_Maybe.fromMaybe(getEmptyRow)(Data_Array.index(matrix)(rowIndex));
              return Data_Maybe.fromMaybe(0)(Data_Array.index(rowData)(colIndex));
          };
      };
  };
  ...
  var updateMatrix$prime = function (matrixBox) {
      return function (rowIndex) {
          return function (colIndex) {
              return function (value) {
                  return Data_Maybe.fromMaybe(matrixBox)(Data_Array.updateAt(rowIndex)(getUpdateColValue(getCurrentRow(matrixBox)(rowIndex))(colIndex)(value))(matrixBox));
              };
          };
      };
  };
  var $$boolean = function (falseCallback) {
      return function (trueCallback) {
          return function (boolValue) {
              ...
              throw new Error("Failed pattern match at Utils.Common line 32, column 1 - line 32, column 65: " + [ falseCallback.constructor.name, trueCallback.constructor.name, boolValue.constructor.name ]);
          };
      };
  };
...
(function(exports) {
  ...
  var updateMatrix = function (matrixBox) {
      return function (rowIndex) {
          return function (rowIndexToReplace) {
              return function (colIndex) {
                  return function (colIndexToReplace) {
                      return function (valToUpdate) {
                          var updateCurrentRow = Utils_Common["updateMatrix'"](matrixBox)(rowIndex)(colIndex)(valToUpdate);
                          return Utils_Common["updateMatrix'"](updateCurrentRow)(rowIndexToReplace)(colIndexToReplace)(0);
                      };
                  };
              };
          };
      ...
      return function (colRange) {
          return function (previousBox) {
                          ...
                          return function (colIndex) {
                              ...
                              if (Data_Boolean.otherwise) {
                                  var trueCallback = function (currentVal) {
                                      return updateMatrix(matrixBox)(stagedRowIndex)(rowIndex)(colIndex)(colIndex)(currentVal);
                                  };
                                  var falseCallback = replaceNextNonZeroValue(matrixBox)(stagedRowIndex)(rowIndex - 1 | 0)(colIndex);
                                  var currentVal = Utils_Common.getValFromMatrix(matrixBox)(rowIndex)(colIndex);
                                  return Utils_Common["boolean"](Data_Function["const"](falseCallback))(Data_Function["const"](trueCallback(currentVal)))(currentVal !== 0);
                              };
                              throw new Error("Failed pattern match at Utils.Movement line 115, column 17 - line 115, column 103: " + [ matrixBox.constructor.name, stagedRowIndex.constructor.name, rowIndex.constructor.name, colIndex.constructor.name ]);
                          };
                      };
                  };
              };
              var removeIntermediateZeros$prime = function (rowIndex) {
                  return function (matrixBox) {
                      return function (colIndex) {
                          var trueCallback = replaceNextNonZeroValue(matrixBox)(rowIndex)(rowIndex - 1 | 0)(colIndex);
                          var currentVal = Utils_Common.getValFromMatrix(matrixBox)(rowIndex)(colIndex);
              ...
              var removeIntermediateZeros = function (matrixBox) {
                  return function (rowIndex) {
                      return Data_Foldable.foldl(Data_Foldable.foldableArray)(removeIntermediateZeros$prime(rowIndex))(matrixBox)(colRange);
                  };
              };
              var getNextNonZeroValue = function (matrixBox) {
                  return function (rowIndex) {
                      return function (colIndex) {
                          if (rowIndex === (-1 | 0)) {
                              return mkFinalCellData(0)(0);
                          };
                          if (Data_Boolean.otherwise) {
                              var falseCallback = getNextNonZeroValue(matrixBox)(rowIndex - 1 | 0)(colIndex);
                              var currentVal = Utils_Common.getValFromMatrix(matrixBox)(rowIndex)(colIndex);
                              return Utils_Common["boolean"](Data_Function["const"](falseCallback))(Data_Function["const"](mkFinalCellData(currentVal)(rowIndex)))(currentVal !== 0);
                          };
                          throw new Error("Failed pattern match at Utils.Movement line 94, column 17 - line 94, column 88: " + [ matrixBox.constructor.name, rowIndex.constructor.name, colIndex.constructor.name ]);
                      };
                  };
              };
              var updateCurrentCell = function (rowIndex) {
                  return function (matrixBox) {
                      return function (colIndex) {
                          var trueCallback = function (nextVal) {
                              return function (currentVal) {
                                  return updateMatrix(matrixBox)(rowIndex)(nextVal.index)(colIndex)(colIndex)(currentVal + nextVal.val | 0);
                              };
                          };
                          ...
                          var currentVal = Utils_Common.getValFromMatrix(matrixBox)(rowIndex)(colIndex);
                          var nextVal = getNextNonZeroValue(matrixBox)(rowIndex - 1 | 0)(colIndex);
              ...
              var updateColVal = function (matrixBox) {
                  return function (rowIndex) {
                      return Data_Foldable.foldl(Data_Foldable.foldableArray)(updateCurrentCell(rowIndex))(matrixBox)(colRange);
                  };
              };
  ...
  var moveLeft = function (rowRange) {
      return function (colRange) {
          return function (previousBox) {
              var replaceNextNonZeroValue = function (matrixBox) {
                  return function (rowIndex) {
                      return function (stagedColIndex) {
                          return function (colIndex) {
                              if (colIndex === Utils_Common.matSize) {
                                  return matrixBox;
                              };
                              if (Data_Boolean.otherwise) {
                                  var trueCallback = function (currentVal) {
                                      return updateMatrix(matrixBox)(rowIndex)(rowIndex)(stagedColIndex)(colIndex)(currentVal);
                                  };
                                  var falseCallback = replaceNextNonZeroValue(matrixBox)(rowIndex)(stagedColIndex)(colIndex + 1 | 0);
                                  var currentVal = Utils_Common.getValFromMatrix(matrixBox)(rowIndex)(colIndex);
                                  return Utils_Common["boolean"](Data_Function["const"](falseCallback))(Data_Function["const"](trueCallback(currentVal)))(currentVal !== 0);
                              };
                              throw new Error("Failed pattern match at Utils.Movement line 169, column 17 - line 169, column 103: " + [ matrixBox.constructor.name, rowIndex.constructor.name, stagedColIndex.constructor.name, colIndex.constructor.name ]);
                          };
                      };
                  };
              };
              var removeIntermediateZeros$prime = function (rowIndex) {
                  return function (matrixBox) {
                      return function (colIndex) {
                          var trueCallback = replaceNextNonZeroValue(matrixBox)(rowIndex)(colIndex)(colIndex + 1 | 0);
                          var currentVal = Utils_Common.getValFromMatrix(matrixBox)(rowIndex)(colIndex);
                          return Utils_Common["boolean"](Data_Function["const"](matrixBox))(Data_Function["const"](trueCallback))(0 === currentVal);
                      };
                  };
              ...
              var getNextNonZeroValue = function (matrixBox) {
                  return function (rowIndex) {
                      return function (colIndex) {
                          if (colIndex === Utils_Common.matSize) {
                              return mkFinalCellData(0)(Utils_Common.matSize - 1 | 0);
                          };
                          if (Data_Boolean.otherwise) {
                              var falseCallback = getNextNonZeroValue(matrixBox)(rowIndex)(colIndex + 1 | 0);
                              var currentVal = Utils_Common.getValFromMatrix(matrixBox)(rowIndex)(colIndex);
                              return Utils_Common["boolean"](Data_Function["const"](falseCallback))(Data_Function["const"](mkFinalCellData(currentVal)(colIndex)))(currentVal !== 0);
                          };
                          throw new Error("Failed pattern match at Utils.Movement line 148, column 17 - line 148, column 88: " + [ matrixBox.constructor.name, rowIndex.constructor.name, colIndex.constructor.name ]);
                      };
                  };
              };
              var updateCurrentCell = function (rowIndex) {
                  return function (matrixBox) {
                      return function (colIndex) {
                          var trueCallback = function (nextVal) {
                              return function (currentVal) {
                                  return updateMatrix(matrixBox)(rowIndex)(rowIndex)(colIndex)(nextVal.index)(currentVal + nextVal.val | 0);
                              };
                          };
                          var boolCondition = function (currentVal) {
                              return function (nextVal) {
                          ...
                          var currentVal = Utils_Common.getValFromMatrix(matrixBox)(rowIndex)(colIndex);
                          var nextVal = getNextNonZeroValue(matrixBox)(rowIndex)(colIndex + 1 | 0);
                          return Utils_Common["boolean"](Data_Function["const"](matrixBox))(Data_Function["const"](trueCallback(nextVal)(currentVal)))(boolCondition(currentVal)(nextVal));
                      };
                  };
              };
  ...
  var moveRight = function (rowRange) {
      return function (colRange) {
          return function (previousBox) {
              var replaceNextNonZeroValue = function (matrixBox) {
                  return function (rowIndex) {
                      return function (stagedColIndex) {
                          return function (colIndex) {
                              ...
                              throw new Error("Failed pattern match at Utils.Movement line 223, column 17 - line 223, column 103: " + [ matrixBox.constructor.name, rowIndex.constructor.name, stagedColIndex.constructor.name, colIndex.constructor.name ]);
                          };
                      };
                  };
              };
              ...
              var getNextNonZeroValue = function (matrixBox) {
                  return function (rowIndex) {
                      return function (colIndex) {
                          ...
                          throw new Error("Failed pattern match at Utils.Movement line 202, column 17 - line 202, column 88: " + [ matrixBox.constructor.name, rowIndex.constructor.name, colIndex.constructor.name ]);
                      };
                  };
              };
              var updateCurrentCell = function (rowIndex) {
          ...
          return function (previousBox) {
              var replaceNextNonZeroValue = function (matrixBox) {
                  return function (stagedRowIndex) {
                      return function (rowIndex) {
                          return function (colIndex) {
                              if (rowIndex === Utils_Common.matSize) {
                                  return matrixBox;
                              };
                              if (Data_Boolean.otherwise) {
                                  var trueCallback = function (currentVal) {
                              ...
                              throw new Error("Failed pattern match at Utils.Movement line 61, column 17 - line 61, column 103: " + [ matrixBox.constructor.name, stagedRowIndex.constructor.name, rowIndex.constructor.name, colIndex.constructor.name ]);
                          };
                      };
                  };
              };
              ...
              var getNextNonZeroValue = function (matrixBox) {
                  return function (rowIndex) {
                      return function (colIndex) {
                          ...
                          throw new Error("Failed pattern match at Utils.Movement line 40, column 17 - line 40, column 88: " + [ matrixBox.constructor.name, rowIndex.constructor.name, colIndex.constructor.name ]);
                      };
                  };
              };
              var updateCurrentCell = function (rowIndex) {
...
(function(exports) {
          ...
          var makeCol = function (rowIndex) {
              return function (colIndex) {
                  return {
                      ...
                      index: makeIndex(colIndex)(rowIndex)
                  };
              };
          };
  ...
  var getEmptyPositions = function (matrixBox) {
      var updateZeroArray = function (rowIndex) {
          return function (accumulator) {
              return function (colIndex) {
                  var currentVal = Utils_Common.getValFromMatrix(matrixBox)(rowIndex)(colIndex);
                  return Utils_Common["boolean"](Data_Function["const"](accumulator))(Data_Function["const"](Data_Array.cons(makeIndex(rowIndex)(colIndex))(accumulator)))(currentVal === 0);
              };
          };
      };
  ...
  var mkMatrixData = function (dimensions) {
      return function (matrix) {
          ...
          var mkCellData = function (point) {
              var matVal = Utils_Common.getValFromMatrix(matrix)(point.index.x)(point.index.y);
              var color = Data_Maybe.fromMaybe(Utils_ColorSchema.defaultColor)(Data_StrMap.lookup(Data_UInt.toString(Data_UInt.fromInt(matVal)))(colorsPair));
              var square = {
                  x: point.x,
                  y: point.y,
  ...
  var callRequiredFunctions = function (v) {
      if (v instanceof UP) {
          return Utils_Movement.moveUp(Data_Array.range(0)(Utils_Common.matSize - 2 | 0))(Data_Array.range(0)(Utils_Common.matSize - 1 | 0));
      };
      if (v instanceof DOWN) {
          return Utils_Movement.moveDown(Data_Array.range(Utils_Common.matSize - 1 | 0)(1))(Data_Array.range(0)(Utils_Common.matSize - 1 | 0));
      };
      if (v instanceof LEFT) {
          return Utils_Movement.moveLeft(Data_Array.range(0)(Utils_Common.matSize - 1 | 0))(Data_Array.range(0)(Utils_Common.matSize - 2 | 0));
      };
      if (v instanceof RIGHT) {
          return Utils_Movement.moveRight(Data_Array.range(0)(Utils_Common.matSize - 1 | 0))(Data_Array.range(Utils_Common.matSize - 1 | 0)(1));
      };
      throw new Error("Failed pattern match at Utils.Utils line 108, column 1 - line 108, column 78: " + [ v.constructor.name ]);
  };
  var makeDecision = function (directions) {
      ...
      var updatedMatrix$prime = Utils_Common["updateMatrix'"](updatedMatrix)(positionToChange.x)(positionToChange.y)(valToInsert);
      return storeAndReturnMatrix(updatedMatrix$prime);
  };
  var printPosition = function (set) {
      if (37 === set) {
          return makeDecision(LEFT.value);
      };
      if (38 === set) {
          return makeDecision(UP.value);
      };
      if (39 === set) {
          return makeDecision(RIGHT.value);
      };
      if (40 === set) {
          return makeDecision(DOWN.value);
      };
      if (Data_Boolean.otherwise) {
          return getAndSetMatrix;
      };
      throw new Error("Failed pattern match at Utils.Utils line 58, column 1 - line 58, column 42: " + [ set.constructor.name ]);
  };
